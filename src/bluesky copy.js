...
const initPage = () => {
    ...
    function updateFixedTitleContent(newContent) {
        fixedTitleContent = newContent;
        typeWrite();
        // if (!isTyping) {
        //     isTyping = true;
        //     setTimeout(() => {
        //         if (fixedTitleContent == newContent) {
        //             return false
        //         }
    ...
    function handleScroll(zoomAbout, trigerTop) {
        ...
        if (productsSectionVisible && fixedTitleContent !== "products") {
            updateFixedTitleContent("products");
        ...
        if (contactsSectionVisible && fixedTitleContent !== "contact") {
            updateFixedTitleContent("contact");
    ...
    window.addEventListener('scroll', function () {
        ...
        if (zoomAbout - trigerTop > 0) {
            fixedTitle.classList.add("close")
        } else {
            fixedTitle.classList.remove("close")
        }
        ...
        sections.forEach((section, index) => {
            // console.log(sectionTops[index] - trigerTop)
            if (sectionTops[index] - trigerTop <= 0) {
